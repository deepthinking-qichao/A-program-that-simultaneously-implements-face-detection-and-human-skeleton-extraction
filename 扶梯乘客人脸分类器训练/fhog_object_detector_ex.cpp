...
{  
    ...
    try
    {
        ...
        // file.
        load_image_dataset(images_train, face_boxes_train, faces_directory+"/train/training.xml");
        load_image_dataset(images_test, face_boxes_test, faces_directory+"/test/testing.xml");
